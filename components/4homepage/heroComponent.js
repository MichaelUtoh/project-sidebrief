    ...
    return (
        <>
            ...
            <Flex alignItems={{ base:"center", md:"flex-start", lg:"flex-start" }} flexDirection="column" justifyContent="center" w={{base:"100%", md:"100%", lg:"60%"}}>
                ...
                <Text color="black" fontSize={{ base: '22px', md: '35px', lg: '42px' }} fontWeight={700} lineHeight={{ base:1.3, md:1.2 }} m={2} textAlign={{ base:"center", md:"left" }} w="90%">
                    Form and manage your company from anywhere.
                </Text>

                <Text color="gray.600" fontSize={{ base:12, md:14 }} fontWeight={700} m={2} textAlign={{ base:"center", md:"left" }} w={{ base:"80%", lg:"80%" }}>
