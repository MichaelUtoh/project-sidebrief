        ...
        <>
            <Flex id="info" bg="#fff" flexDirection="column" justifyContent="space-between" my={{ base:5 }} px={{ base:"15px", md:"30px", lg:90}} py={{ base:5, md:"70px" }}>
                ...
                <Flex flexDirection="column" w="50%">
                    <Flex flexDirection={{ base:"column", md:"row" }} justifyContent={{ base:"flex-start" }} mb={14}>
                    ...
                    <Flex flexDirection={{ base:"column-reverse", md:"row" }} justifyContent={{ base:"flex-start" }} mb={14}>
                ...
                <Flex bg="" flexDirection="column" p={4} w="50%">
                   <Image src="56420-cubes.gif" />
                </Flex>
                </Flex>
