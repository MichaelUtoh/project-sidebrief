...
const InfoComponent = () => {
    return (
        <>
            <Flex alignItems="center" bg="cyan.400" borderRadius={10} h={400} flexDirection="column" justifyContent="center" px={{ base:"15px", md:"30px", lg:90}} my={10} mx="auto" w={{ base:"90%", md:"80%" }}>
                {/* Welcome text */}
