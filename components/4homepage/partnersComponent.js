    ...
    return (
        <>
            <Flex bg="#f8f8f8" alignItems={{ base:"center" }} flexDirection="column" px={{ base:"15px", md:"30px", lg:90}} py={2}>
                ...
                <Text color="#5a5a5a" fontFamily="poppins" fontSize={{ base:12, md:14, lg:16 }} fontWeight={500} textAlign="center">Join companies from Africa, US, UK and Asia using Sidebrief.</Text>
                <SliderComponent />
            </Flex>
        </>
    )
