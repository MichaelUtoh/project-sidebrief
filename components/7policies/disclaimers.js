        ...
        <>
            ...
            >
                ...
                <Flex alignItems="center" bg="gray.50" flexDirection="column" py={4} w="full">
                    <Text color="gray.700" fontWeight={700}>General Disclaimers</Text>
                    <Text color="gray.400" fontSize={14} mt={0}>Disclaimers on our services.</Text>
                </Flex>

                <Flex flexDirection="column" p={{ base:15, md:50 }} w="100%">

                    <Text borderLeft="4px" borderColor="cyan.400" pl={3} my={2}>Disclaimers.</Text>
